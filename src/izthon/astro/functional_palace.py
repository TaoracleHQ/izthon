...
class FunctionalPalace:
    ...
    def flies_one_of_to(self, to: int | str, with_mutagens: list[str]) -> bool:
        ...
        if not stars:
            return True
        return to_palace.has_one_of(stars)
